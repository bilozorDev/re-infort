      ...
      <div className="w-full">
        ...
        <div className={label ? "mt-2 grid grid-cols-1" : "grid grid-cols-1"}>
          <select
            ...
            id={id}
            className={cn(
              "col-start-1 row-start-1 w-full appearance-none rounded-md bg-white py-1.5 pr-10 pl-3 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6",
