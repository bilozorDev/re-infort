...
describe("Inventory Service", () => {
  ...
  describe("getInventoryByWarehouse", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(getInventoryByWarehouse("warehouse-1", "org_test123")).rejects.toThrow(
        "Failed to fetch inventory: Database error"
      );
    });
  });
  ...
  describe("getInventoryByProduct", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(getInventoryByProduct("prod-1", "org_test123")).rejects.toThrow(
        "Failed to fetch product inventory: Database error"
      );
    });
  });
  ...
  describe("getProductTotalInventory", () => {
    ...
    it("should throw error when RPC fails", async () => {
      ...
      await expect(getProductTotalInventory("prod-1")).rejects.toThrow(
        "Failed to fetch product total inventory: RPC error"
      );
    });
  });
  ...
  describe("adjustInventory", () => {
    ...
    it("should throw error when adjustment fails", async () => {
      ...
      await expect(adjustInventory(adjustment)).rejects.toThrow(
        "Failed to adjust inventory: Insufficient inventory"
      );
    });
  });
  ...
  describe("transferInventory", () => {
    ...
    it("should throw error when transfer fails", async () => {
      ...
      await expect(transferInventory(transfer)).rejects.toThrow(
        "Failed to transfer inventory: Insufficient inventory"
      );
    });
  });
  ...
  describe("reserveInventory", () => {
    ...
    it("should throw error when reservation fails", async () => {
      ...
      await expect(reserveInventory("prod-1", "warehouse-1", 100)).rejects.toThrow(
        "Failed to reserve inventory: Insufficient available inventory"
      );
    });
  });
  ...
  describe("releaseReservation", () => {
    ...
    it("should throw error when release fails", async () => {
      ...
      await expect(releaseReservation("prod-1", "warehouse-1", 5)).rejects.toThrow(
        "Failed to release reservation: No reservation found"
      );
    });
  });
  ...
  describe("getStockMovements", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(getStockMovements({}, "org_test123")).rejects.toThrow(
        "Failed to fetch stock movements: Database error"
      );
    });
  });
  ...
  describe("getRecentMovements", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(getRecentMovements(10, "org_test123")).rejects.toThrow(
        "Failed to fetch recent movements: Database error"
      );
    });
  });
  ...
  describe("getLowStockItems", () => {
    ...
    it("should throw error when query fails", async () => {
      ...
      await expect(getLowStockItems("org_test123")).rejects.toThrow(
        "Failed to fetch low stock items: Database error"
      );
    });
  });
  ...
  describe("createManualMovement", () => {
    it("should create a manual stock movement", async () => {
      ...
      const result = await createManualMovement(input, "org_test123", "user_test", "Test User");
    ...
    it("should throw error when creation fails", async () => {
      ...
      await expect(
        createManualMovement(input, "org_test123", "user_test", "Test User")
  ...
  describe("cancelMovement", () => {
    ...
    it("should throw error when cancellation fails", async () => {
      ...
      await expect(cancelMovement("move-1", "org_test123", "user_test")).rejects.toThrow(
        "Failed to cancel movement: Movement not found"
      );
    });
  });
});
