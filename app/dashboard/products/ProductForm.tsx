                                            ...
                                            >
                                              <div className="relative">
                                                ...
                                                >
                                                  <ListboxOptions
                                                    anchor="bottom"
                                                    className="z-50 w-[var(--button-width)] mt-1 max-h-60 overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black/5 focus:outline-none sm:text-sm [--anchor-gap:4px]"
                                                  >
                                                    <ListboxOption
                                                      value=""
                                                      className={({ focus }) =>
                            ...
                            <form.Field name="subcategory_id">
                              {(field) => {
                                const selectedSubcategory = subcategoryOptions.find(
                                  (sub) => sub.value === field.state.value
                                );
                                return (
                                  <div className="space-y-2">
                                    <div className="flex items-center justify-between">
                                              ...
                                              <div className="relative">
                                                <ListboxButton
                                                  className={`relative w-full cursor-default rounded-md bg-white py-1.5 pl-3 pr-10 text-left text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-600 sm:text-sm/6 ${
                                                    !currentCategoryId || subcategoriesLoading
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-2">
                          ...
                          <div>
                            ...
                            {/* Markup Pills */}
                            <form.Subscribe
                              selector={(state) => [state.values.cost, state.values.price]}
                            >
                              {([cost, price]) => {
                      ...
                      <div className="space-y-6">
                        ...
                        {featureDefinitions && featureDefinitions.length > 0 ? (
                          ...
                          <div className="text-sm text-gray-500">
                            ...
                            <p className="mt-1">
                              You can add custom features below to specify product attributes.
                            </p>
                          </div>
                        )}
                        ...
                        <div className="space-y-4">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              type="button"
                              onClick={() =>
                                setCustomFeatures([...customFeatures, { name: "", value: "" }])
                              }
                            ...
                            {(values) => {
                              ...
                              return (
                                ...
                                >
                                  Next
                                  <ChevronRightIcon
                                    className="ml-1.5 -mr-0.5 h-5 w-5"
                                    aria-hidden="true"
                                  />
                                </button>
                              );
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Product features allow you to define specific attributes and specifications for your
              products. They help organize and standardize product information across your
              inventory.
            </p>
          </div>
            ...
            <div className="mt-2 space-y-3">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  These are predefined features that appear based on the category and subcategory
                  you select. For example, electronics might have &ldquo;Screen Size&rdquo; or
                  &ldquo;Battery Life&rdquo;.
                </p>
              </div>
              <div>
                <h4 className="text-sm font-medium text-gray-900">Custom Features</h4>
                <p className="text-sm text-gray-600">
                  You can add your own custom features for any product to capture unique
                  specifications not covered by the predefined options.
                </p>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <ol className="mt-2 space-y-2 text-sm text-gray-600">
              ...
              <li className="flex">
                ...
                <span>
                  Click &ldquo;Add Custom Feature&rdquo; to include additional specifications
                </span>
              </li>
              <li className="flex">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              Administrators can manage feature definitions for categories and subcategories to
              ensure consistent product information across your organization.
            </p>
            <div className="mt-3">
              <a
